...
CREATE TABLE public.merchant_payout_profiles (
  ...
  type TEXT NOT NULL DEFAULT 'GROSS' CHECK (type IN ('GROSS', 'NET')),
  ...
  -- NET type fields
  net_frequency TEXT CHECK (net_frequency IN ('DAILY', 'MONTHLY', 'CONTINUOUS')),
  net_submission_delay_days INTEGER,
  net_payment_instrument_id TEXT,
  net_rail TEXT CHECK (net_rail IN ('NEXT_DAY_ACH', 'SAME_DAY_ACH')),
  
  -- GROSS type fields (nullable for NET)
  gross_payouts_frequency TEXT CHECK (gross_payouts_frequency IN ('DAILY', 'MONTHLY', 'CONTINUOUS')),
  gross_payouts_submission_delay_days INTEGER,
  gross_payouts_payment_instrument_id TEXT,
  gross_payouts_rail TEXT CHECK (gross_payouts_rail IN ('NEXT_DAY_ACH', 'SAME_DAY_ACH')),
  gross_fees_frequency TEXT CHECK (gross_fees_frequency IN ('DAILY', 'MONTHLY', 'CONTINUOUS')),
  ...
  gross_fees_rail TEXT CHECK (gross_fees_rail IN ('NEXT_DAY_ACH', 'SAME_DAY_ACH')),
