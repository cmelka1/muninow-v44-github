...
-- Since we need to first assign the merchant_id, then update the other fields, let's do this in two steps
-- Step 1: Randomly assign merchant_id to bills without one
UPDATE master_bills 
SET 
  merchant_id = (
    CASE 
      WHEN master_bills.bill_id % 3 = 0 THEN '4ffd550f-edcd-4f48-8565-f8401c197209'::uuid
      WHEN master_bills.bill_id % 3 = 1 THEN 'dfc7782d-6e2a-4201-9c12-35c8925add4b'::uuid
