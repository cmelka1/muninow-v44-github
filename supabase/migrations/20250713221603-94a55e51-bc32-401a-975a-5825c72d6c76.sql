-- Fix ambiguous column references in municipal user functions

-- Fix get_user_profile_for_municipal function
...
-- Fix get_user_bill_summary_for_municipal function
