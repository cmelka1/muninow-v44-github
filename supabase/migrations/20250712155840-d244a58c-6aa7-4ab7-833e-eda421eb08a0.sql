...
-- Step 1: Randomly assign merchant_id to bills without one using a different approach
UPDATE master_bills 
SET 
  merchant_id = (
    CASE 
      WHEN extract(epoch from bill_id::text::timestamp)::bigint % 3 = 0 THEN '4ffd550f-edcd-4f48-8565-f8401c197209'::uuid
      WHEN extract(epoch from bill_id::text::timestamp)::bigint % 3 = 1 THEN 'dfc7782d-6e2a-4201-9c12-35c8925add4b'::uuid
