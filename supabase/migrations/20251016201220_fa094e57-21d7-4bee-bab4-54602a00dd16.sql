...
COMMENT ON FUNCTION check_expiring_licenses() IS 
  'Checks all issued licenses and updates their renewal_status based on expiration dates. Returns list of updated licenses with fully qualified column references to avoid ambiguity.';