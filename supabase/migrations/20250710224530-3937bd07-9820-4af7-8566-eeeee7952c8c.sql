...
-- Phase 1: Drop migration artifact tables
DROP TABLE IF EXISTS public.role_migration_backup CASCADE;
DROP TABLE IF EXISTS public.role_migration_results CASCADE;
