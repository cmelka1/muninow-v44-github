-- Data Migration: Transfer municipal_bills to master_bills (Fixed)
...
SELECT
  ...
  COALESCE(municipality_id, gen_random_uuid()) as customer_id, -- Fixed: using UUID directly
  ...
  -- User Profile Information (Bill Payer)  
  user_id as profile_id, -- Fixed: using UUID directly
  user_id,
  first_name,
  last_name,
  user_email as email,
