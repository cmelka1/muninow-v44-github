-- Fix the create_tax_submission_before_payment function to include total_amount_due_cents
...
BEGIN
  ...
  INSERT INTO public.tax_submissions (
    ...
    p_tax_year,
    p_amount_cents,
    p_amount_cents, -- Set total_amount_due_cents to the same as amount_cents for now
    p_calculation_notes,
    'draft',
    'unpaid',
    now(),
