-- Update create_tax_submission_before_payment function to remove total_amount_cents references
-- This fixes the PostgreSQL error caused by referencing the dropped column
...
DECLARE
  ...
  result jsonb;
BEGIN
  -- Create tax submission without total_amount_cents
  ...
  INSERT INTO public.payment_history (
    ...
    p_amount_cents,
    p_service_fee_cents,
    p_total_amount_due_cents, -- Use total_amount_due_cents for payment history total
    p_payment_type,
    'pending',
    p_payment_type,
