-- ============================================
-- Migration: Fix NULL handling in communication notifications
-- Description: Update trigger to use NULL-safe string concatenation
-- ============================================
...
'Trigger function to create notifications when comments are added. Uses NULL-safe CONCAT for string handling to prevent constraint violations.';