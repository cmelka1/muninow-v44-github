-- Drop all specific versions of the create_unified_payment_transaction function
DROP FUNCTION IF EXISTS public.create_unified_payment_transaction(text, uuid, bigint, text, text, text, text, text, text, text, text, text, text) CASCADE;
DROP FUNCTION IF EXISTS public.create_unified_payment_transaction(uuid, uuid, uuid, text, text, date, date, integer, bigint, jsonb, text, text, bigint, bigint, text, text, text, text, text, text, text, text, text, text, text, text) CASCADE;
DROP FUNCTION IF EXISTS public.create_unified_payment_transaction(uuid, uuid, uuid, text, text, date, date, integer, bigint, text, bigint, text, text, bigint, bigint, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text) CASCADE;
