-- Fix permit notification trigger to use permit_types_v2 instead of deprecated permit_types
...
BEGIN
  ...
  IF OLD.application_status IS DISTINCT FROM NEW.application_status THEN
    ...
    -- Get permit type name from permit_types_v2 (FIXED: was permit_types)
...
-- Recreate the trigger to ensure it's bound to the updated function
