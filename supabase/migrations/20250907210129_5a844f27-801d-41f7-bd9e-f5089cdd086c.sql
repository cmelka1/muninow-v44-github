-- Drop all specific versions of create_unified_payment_transaction function
-- 13 parameter version
DROP FUNCTION IF EXISTS public.create_unified_payment_transaction(
  uuid, uuid, uuid, text, uuid, bigint, text, text, text, text, text, text, text
);

-- 16 parameter version (current edge function call)
DROP FUNCTION IF EXISTS public.create_unified_payment_transaction(
  uuid, uuid, uuid, text, uuid, bigint, text, text, text, text, text, text, text, text, text, text
);

-- 17 parameter version (with finix_merchant_id)
DROP FUNCTION IF EXISTS public.create_unified_payment_transaction(
  uuid, uuid, uuid, text, uuid, bigint, text, text, text, text, text, text, text, text, text, text, text
);

-- 19 parameter version
DROP FUNCTION IF EXISTS public.create_unified_payment_transaction(
  uuid, uuid, uuid, text, uuid, bigint, text, text, text, text, text, text, text, text, text, text, text, text, text
);

-- 21 parameter version
DROP FUNCTION IF EXISTS public.create_unified_payment_transaction(
  uuid, uuid, uuid, text, uuid, bigint, text, text, text, text, text, text, text, text, text, text, text, text, text, text, text
);
