-- Fix the create_tax_submission_with_payment function to properly handle payment_history insertion
...
BEGIN
  ...
  -- Create payment history record with correct column names
