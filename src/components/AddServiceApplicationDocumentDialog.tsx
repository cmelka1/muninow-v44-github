...
interface AddServiceApplicationDocumentDialogProps {
  open: boolean;
...
export const AddServiceApplicationDocumentDialog: React.FC<AddServiceApplicationDocumentDialogProps> = ({
  open,
  onOpenChange,
  applicationId,
  customerId,
  ...
  const handleUpload = async () => {
    ...
    try {
      // Create file path: userId/applicationId/timestamp-filename
      const timestamp = Date.now();
      const sanitizedFileName = selectedFile.name.replace(/[^a-zA-Z0-9.-]/g, '_');
      const filePath = `${user.id}/${applicationId}/${timestamp}-${sanitizedFileName}`;
      ...
      toast({
        ...
        description: "Your document has been successfully uploaded to the application"
      });
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload a new document to this service application
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          <div>
            ...
            <Input
              ...
              placeholder="Enter document type (e.g., License Application, Certificate, Supporting Document)"
            />
          </div>
